<template>
  <div id="app">
    <b-navbar toggleable="md" variant="dark" type="dark">
      ...
      <img src="./assets/home.gif" class="img-circle" style="padding: 5px">
      ...
      <b-collapse is-nav id="nav_collapse">
        <b-navbar-nav>
          ...
          <b-nav-item to="/release"><i class="fa fa-puzzle-piece" style="padding: 5px"> Release</i></b-nav-item>
...
#app {
  ...
  color: #2c3e50;
  padding-top: 20px;
  background: url("./assets/zhou.jpg") repeat center top;
}
.VueTables__sortable {
  cursor: pointer;
}
